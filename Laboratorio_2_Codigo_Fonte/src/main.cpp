...
// Variáveis que controlam as teclas pressionadas pelo usuário.
...
int main()
{
    ...
    // Variável de velocidade de movimento da câmera
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec4 camera_view_vector = normalize(camera_position_c); // Vetor "view", sentido para onde a câmera está virada

        glm::vec4 camera_up_vector = glm::vec4(0.0f, 1.0f, 0.0f, 0.0f); // Vetor "up" fixado para apontar para o "céu" (eito Y global)

        glm::vec4 vetor_w = -camera_view_vector;                     // w é o vetor "z" dos slides 195-227 e 229-234 do documento Aula_08_Sistemas_de_Coordenadas.pdf.
        glm::vec4 vetor_u = crossproduct(camera_up_vector, vetor_w); // u é o vetor "x" dos slides 195-227 e 229-234 do documento Aula_08_Sistemas_de_Coordenadas.pdf.
