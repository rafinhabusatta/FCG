...
GLuint BuildTriangles()
{
    ...
    //    X              Y     Z     W
         ...
         // Triângulos externos
         cos(RAD*0)*0.7f,     sin(RAD*0)*0.0f, 0.0f, 1.0f,
         cos(RAD*22.5)*0.7f,  sin(RAD*22.5)*0.7f, 0.0f, 1.0f,
         cos(RAD*45)*0.7f,    sin(RAD*45)*0.7f, 0.0f, 1.0f,
         cos(RAD*67.5)*0.7f,   sin(RAD*67.5)* 0.7f, 0.0f, 1.0f,
         cos(RAD*90)*0.7f,    sin(RAD*90)*0.7f, 0.0f, 1.0f,

         cos(RAD*112.5)*0.7f, sin(RAD*112.5)*0.7f, 0.0f, 1.0f,
         cos(RAD*135)*0.7f,   sin(RAD*135)*0.7f, 0.0f, 1.0f,
         cos(RAD*157.5)*0.7f, sin(RAD*157.5)*0.7f, 0.0f, 1.0f,
         cos(RAD*180)*0.7f,   sin(RAD*180)*0.7f, 0.0f, 1.0f,

          cos(RAD*202.5)*0.7f, sin(RAD*202.5)*0.7f, 0.0f, 1.0f,
         cos(RAD*225)*0.7f,   sin(RAD*225)* 0.7f, 0.0f, 1.0f,
         cos(RAD*247.5)*0.7f, sin(RAD*247.5)* 0.7f, 0.0f, 1.0f,
         cos(RAD*270)*0.7f,   sin(RAD*270)* 0.7f, 0.0f, 1.0f,

         cos(RAD*292.5)*0.7f, sin(RAD*292.5)* 0.7f, 0.0f, 1.0f,
         cos(RAD*315)*0.7f,   sin(RAD*315)* 0.7f, 0.0f, 1.0f,
         cos(RAD*337.5)*0.7f, sin(RAD*337.5)* 0.7f, 0.0f, 1.0f,

        // Triângulos internos
         cos(RAD*0)*0.5f,     sin(RAD*0)*0.0f, 0.0f, 1.0f,
         cos(RAD*22.5)*0.5f,  sin(RAD*22.5)*0.5f, 0.0f, 1.0f,
         cos(RAD*45)*0.5f,    sin(RAD*45)*0.5f, 0.0f, 1.0f,
         cos(RAD*67.5)*0.5f,   sin(RAD*67.5)* 0.5f, 0.0f, 1.0f,
         cos(RAD*90)*0.5f,    sin(RAD*90)*0.5f, 0.0f, 1.0f,

         cos(RAD*112.5)*0.5f, sin(RAD*112.5)*0.5f, 0.0f, 1.0f,
         cos(RAD*135)*0.5f,   sin(RAD*135)*0.5f, 0.0f, 1.0f,
         cos(RAD*157.5)*0.5f, sin(RAD*157.5)*0.5f, 0.0f, 1.0f,
         cos(RAD*180)*0.5f,   sin(RAD*180)*0.5f, 0.0f, 1.0f,

          cos(RAD*202.5)*0.5f, sin(RAD*202.5)*0.5f, 0.0f, 1.0f,
         cos(RAD*225)*0.5f,   sin(RAD*225)* 0.5f, 0.0f, 1.0f,
         cos(RAD*247.5)*0.5f, sin(RAD*247.5)* 0.5f, 0.0f, 1.0f,
         cos(RAD*270)*0.5f,   sin(RAD*270)* 0.5f, 0.0f, 1.0f,

         cos(RAD*292.5)*0.5f, sin(RAD*292.5)* 0.5f, 0.0f, 1.0f,
         cos(RAD*315)*0.5f,   sin(RAD*315)* 0.5f, 0.0f, 1.0f,
         cos(RAD*337.5)*0.5f, sin(RAD*337.5)* 0.5f, 0.0f, 1.0f
    };
